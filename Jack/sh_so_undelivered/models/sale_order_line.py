...
class QuotationOrderLine(models.Model):
    ...
    so_order_date = fields.Datetime(related="order_id.date_order",string="Sales order date")
    is_delivered = fields.Boolean("Is Delivered",store=True, compute="get_delivered")
